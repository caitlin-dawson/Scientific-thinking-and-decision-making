...
The following chunks process each task to extract relevant information for each participant (keeping data in wide format). The chunks also include lines to exclude outlier *trials* based on reaction time, since individual trials with outlier RTs probably indicate 1) technical error, 2) ppts pressing buttons without trying, 3) long RTs caused by ppts taking unsanctioned breaks. At the end of each task chunk, participants who did not consent/stated that their data are not valid were omitted. 
