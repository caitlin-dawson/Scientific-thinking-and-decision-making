...
**NOTE: double FA is not an issue? (i.e., first running CFA for each and then doing the EFA)** -> GET RID + CHECK 95%
...
# There is a section where we decide how many missing quesstionnaires is too much (should be after this; check)
...
# Outlier detection: is it necessary? look into it
...
# DOUBLE CHECK: are NA scores encoded as 0s or NAs? they need to be NAs
# Maybe a loop  later on for entire dataset
