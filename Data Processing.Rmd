...
# Shapiro-Wilks tests
shapiro_p_epicur_sum <- data.frame(name = rep(0, 2), p_value = rep(0, 2))
for (i in 1:length(epicur_sum)) {
...
data_Q_total <- data_Q_total %>%
  mutate(IH_omit = case_when(((max(table(c(IH1rev1, IH2rev1, IH3rev1, IH4rev1, IH5rev1, IH6norm2, IH7norm2, IH8norm2, IH9norm2, IH10norm2, IH11norm3, IH12norm3, IH13norm3, IH14norm3, IH15norm3, IH16norm3, IH17rev4, IH18rev4, IH19rev4, IH20rev4, IH21rev4, IH22rev4)))/length(c(IH1rev1, IH2rev1, IH3rev1, IH4rev1, IH5rev1, IH6norm2, IH7norm2, IH8norm2, IH9norm2, IH10norm2, IH11norm3, IH12norm3, IH13norm3, IH14norm3, IH15norm3, IH16norm3, IH17rev4, IH18rev4, IH19rev4, IH20rev4, IH21rev4, IH22rev4))) >= .95) | (END.QUESTIONNAIRE.INT.HUM <= 22000) ~ 1, 
     ((max(table(c(IH1rev1, IH2rev1, IH3rev1, IH4rev1, IH5rev1, IH6norm2, IH7norm2, IH8norm2, IH9norm2, IH10norm2, IH11norm3, IH12norm3, IH13norm3, IH14norm3, IH15norm3, IH16norm3, IH17rev4, IH18rev4, IH19rev4, IH20rev4, IH21rev4, IH22rev4)))/length(c(IH1rev1, IH2rev1, IH3rev1, IH4rev1, IH5rev1, IH6norm2, IH7norm2, IH8norm2, IH9norm2, IH10norm2, IH11norm3, IH12norm3, IH13norm3, IH14norm3, IH15norm3, IH16norm3, IH17rev4, IH18rev4, IH19rev4, IH20rev4, IH21rev4, IH22rev4)) < .95) & (END.QUESTIONNAIRE.INT.HUM > 22000) ~ 0))) 
...
# Shapiro-Wilks test
shapiro_p_IH <- data.frame(name = rep(0, 22), p_value = rep(0, 22))
for (i in 1:length(IH)) {
...
# Shapiro-Wilks test
shapiro_p_IH_sum <- data.frame(name = rep(0, 4), p_value = rep(0, 4))
for (i in 1:length(IH_sum)) {
...
# Omit Need for closure data based on Clo_omit
data_Q_total[which(data_Q_total$Clo_omit == 1), need_clo] <- NA
...
# Shapiro-Wilks test
shapiro_p_need_clo <- data.frame(name = rep(0, 15), p_value = rep(0, 15))
for (i in 1:length(need_clo)) {
...
modelClo.est <- cfa(modelClo, data = data_Q_total, std.lv = TRUE)
...
# Omit Need for cognition data based on Cog_omit column
data_Q_total[which(data_Q_total$Cog_omit == 1), need_cog] <- NA

# Reverse-coding
for (i in length(need_cog_rev)) {
...
# Shapiro-Wilks test
shapiro_p_need_cog <- data.frame(name = rep(0, 18), p_value = rep(0, 18))
for (i in 1:length(need_cog)) {
