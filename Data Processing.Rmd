...
data_T_sub$NeckerTotalRatelog <- log10(data_T_sub$NeckerTotalRate + 1) # added 1 because log10 cannot handle 0s
...
data_T_sub <- data_T_sub %>% 
  select(Participant.Private.ID, GNGdprime, GNGbetalog, MeanGoRT, SDGoRT, GlobalToLocalInterferencelog, GlobalToLocalPrecedencelog, NeckerTotalRatelog, FlexSum)
