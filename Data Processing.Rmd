...
**NOTE: only for reverse-coded items?**
...
The default scaling constraint/identifcation constraints imposed when using the cfa() function are to fix the loading of the first item of each latent variable to 1. We can override this by setting std.lv = TRUE. This will instead scale the latent variables **(their variances)** by fixing them to 1.
