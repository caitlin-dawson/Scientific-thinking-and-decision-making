...
setwd("//ad.helsinki.fi/home/c/cdawson/Desktop/Scientific-thinking_copy")
...
# Save CI task data
#write.csv(data_citiT, "C:/Users/Omistaja/OneDrive/Tiedostot/GitHub/Scientific-thinking/data_citiT.csv", row.names = FALSE)
...
NB: Strings in following sections affected by the update. The old version is kept but commented out. 
...
# Create binary heuristic scores (0=all normative, 1=at least one heuristic response)
...
#HE: 57.14% make at least one heuristic response
#HR: 59.45% make at least one heuristic response 
...
# Save data
# write.csv(data_efa, "C:/Users/Omistaja/OneDrive/Tiedostot/GitHub/Scientific-thinking/data_efa.csv", row.names = FALSE)
