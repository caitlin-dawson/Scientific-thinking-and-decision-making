...
cor.test(all_reactiontime$Age, all_reactiontime$Reaction.Time, 
         method="spearman", exact=FALSE)
cor.test(all_reactiontime$gender, all_reactiontime$Reaction.Time, 
         method="spearman", exact=FALSE)
cor.test(all_reactiontime$Education, all_reactiontime$Reaction.Time, 
         method="spearman", exact=FALSE)
