...
MILLA: 
SOURCE-LEVEL: words per minute (calculate for each source) -> calculate minimum reading times? but don't exclude anyone / any data
OVERALL: none
questionnaires: no exclusion criteria for RT
...
# MILLA: check this; we also want to know the order in which they were presented for each participant -> we want the source topic and the trial number/order
data_citiT <- data_citiT %>% 
